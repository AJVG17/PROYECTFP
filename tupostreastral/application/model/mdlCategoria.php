...
class mdlCategoria {
    ...
    public function crearCategoria(){
        ...
        $stm->bindParam(1, $this->Nombre_Categoria);
    ...
    public function listarCategoria(){
        ...
        $sql="SELECT idCategoria, Nombre_Categoria, Descripcion FROM categoria ORDER BY idCategoria ASC";
    ...
    public function modificarCategoria(){
        //definir la variable que guarda la consulta
        $sql="UPDATE categoria SET Nombre_Categoria=?, Descripcion=? WHERE idCategoria=?";
