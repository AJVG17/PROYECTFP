...
class mdlMarca{
    ...
    public function crearMarca(){
        ...
        $sql="INSERT INTO marcas(Nombre_Marca, Descripcion) VALUES (?,?)";
        //crear la variable para enviar los datos
        $stm = $this->db->prepare($sql);
        $stm->bindParam(1, $this->Nombre_Marca);
    ...
    public function listarMarca(){
        ...
        $sql="SELECT idMarca, Nombre_Marca, Descripcion FROM marcas ORDER BY idMarca ASC";
    ...
    public function modificarMarca(){
        //definir la variable que guarda la consulta
        $sql="UPDATE marcas SET Nombre_Marca=?, Descripcion=? WHERE idMarca=?";
